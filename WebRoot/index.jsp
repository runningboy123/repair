  ...
  <div class="container"><!-- container-fluid靠左 -->
    ...
    <div class="collapse navbar-collapse" id="demo-navbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="train/train.jsp">培训课堂</a></li>
        ...
        <div class="item">
            ...
            <div class="container">
                <div class="carousel-caption">
                    ...
                    <p><a class="btn btn-lg btn-primary" href="train/train.jsp" target="_blank"
  ...
  <!-- 简介 -->
    <div class="row" >
        ...
        <div class="col-md-4">
            ...
            <p><a class="btn btn-default" href="train/train.jsp" role="button">点击进入</a></p>
        </div>
        <div class="col-md-4">
